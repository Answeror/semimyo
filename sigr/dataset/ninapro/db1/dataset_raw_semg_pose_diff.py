...
class Dataset(BaseDataset):
    ...
    def get_dataiter(self, combos, **kargs):
        ...
        assert semg and pose and diff, 'Empty data'
...
class GetTrial(BaseGetTrial):
    ...
    def __call__(self, combo):
        ...
        semg, pose, diff, local_gesture = self.memo[path][
        ...
        return Trial(data=(semg, pose, diff), gesture=gesture, subject=subject)
    ...
    def _segment(self, semg, pose, gesture):
        ...
        for begin, end in zip(breaks[:-1], breaks[1:]):
            ...
            if g > 0:
                ...
                data[(g, trials[g])] = (semg[begin:end], pose[begin:end], diff[begin:end], gesture[begin:end])
        return data
