...
class Dataset(SingleSessionMixin, Base):
    ...
    @classmethod
    def parse(cls, text):
        if cls is not Dataset and hasattr(cls, 'name') and text == cls.name:
...
#  from . import (
    ...
    #  db1_matlab_lowpass,
    #  db1_raw_semg_glove,
    #  db1_raw_semg_libhand,
    #  db1_raw_semg_spot,
    #  db1_raw_semg_latent_128,
    #  db1_raw_semg_latent_8,
    #  db1_raw_semg_latent_3,
    #  db1_raw_semg_pose_128,
#  )
