...
from ...principal_velocity_segmentation import PrincipalVelocitySegmentation as PVS
...
class Dataset(Base):
    ...
    name = 'ninapro-db1-raw/semg-spot'
    ...
    def get_dataiter(self, combos, **kargs):
        ...
        return DataIter(
            ...
            label=OrderedDict([('gesture', gesture), ('spot', spot)]),
