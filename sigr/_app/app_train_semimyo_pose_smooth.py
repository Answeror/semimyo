...
@app.command()
@click.option('--stochastic-input')
@click.option('--stochastic-net')
@click.option('--num-stochastic-sample', type=int)
...
@click.option('--smooth-loss-weight', type=float, required=True)
