...
class Symbol(FastLocallyConnectedMixin, BaseSymbol):
    ...
    def __init__(
        ...
        **kargs
        ...
        gesture_branch, others = self.get_gesture_branch(
            pose_branch,
        ...
        if self.for_training:
            self.net = mx.symbol.Group([gesture_branch, pose_branch] + others)
        else:
    ...
    def get_gesture_branch(self, pose_net, data, text, gesture_loss_weight):
        ...
        return self.get_gesture_output(net, pose_net), branches
